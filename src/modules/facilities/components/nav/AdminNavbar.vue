<template>
  <div
    ...
    <div
        ...
        class="fixed  top-0 left-0 h-screen w-4/5 z-20 flex-col px-4 pt-4 gap-8 text-lg md:text-sm lg:text-base  text-white lg:relative lg:h-full lg:flex-row lg:items-center lg:justify-end  bg-secondary lg:bg-transparent">
      <font-awesome-icon
          @click="isOpen = false"
